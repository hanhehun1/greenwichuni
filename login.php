...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-in-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Feb 2021 12:52:49 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <!-- waves.css -->
  <link rel="stylesheet" href="assets/pages/waves/css/waves.min.css" type="text/css" media="all"><!-- feather icon -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-12">
          ...
          <form id="frmChange" class="md-float-material form-material" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="auth-box card">
              <div class="card-block">
                ...
                <p class="text-muted text-center p-b-5">Sign in to Training System with your provided account</p>
...
<!-- Mirrored from demo.dashboardpack.com/admindek-html/default/auth-sign-in-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Feb 2021 12:52:50 GMT -->
